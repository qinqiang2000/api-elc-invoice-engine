...
<!--PATTERN UBL-model-->
	...
	<!--RULE -->
<xsl:template match="cac:LegalMonetaryTotal" mode="M12" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[normalize-space(cbc:ID) = 'NG'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='GST']" mode="M12" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine | cac:CreditNoteLine" mode="M12" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty" mode="M12" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxRepresentativeParty" mode="M12" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:Invoice/cac:TaxTotal | /cn:CreditNote/cac:TaxTotal" mode="M12" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal" mode="M12" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="exists(cac:TaxCategory[cac:TaxScheme/cbc:ID='GST']/cbc:Percent) or (normalize-space(cac:TaxCategory[cac:TaxScheme/cbc:ID='GST']/cbc:ID)='')">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[contains( ' SR SRCA-S SRCA-C ZR SRRC SROVR-RS SROVR-LVG SRLVG ',concat(' ',normalize-space(cbc:ID),' ') ) ] " mode="M13" priority="1000">
    <svrl:fired-rule context="cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[contains( ' SR SRCA-S SRCA-C ZR SRRC SROVR-RS SROVR-LVG SRLVG ',concat(' ',normalize-space(cbc:ID),' ') ) ] " />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( ( not(contains(normalize-space(.),' ')) and contains( ' SR SRCA-S SRCA-C ZR ES33 ESN33 DS OS NG SRRC SROVR-RS SROVR-LVG SRLVG NA ',concat(' ',normalize-space(.),' ') ) ) )">
